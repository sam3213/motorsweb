    ...
    var S = function (g) {
        ...
        function L(a, b, c, d) {
            var e = a.aoData.length,
                f = g.extend(!0, {}, m.models.oRow, { src: c ? "dom" : "data", idx: e });
            f._aData = b;
            a.aoData.push(f);
            ...
            if (-1 !== g.inArray(!1, b)) C(a, !1);
                ...
                if (0 !== j.length) {
                    ...
                    (c = f.sZeroRecords),
                        ...
                        (b[0] = g("<tr/>", { class: e ? d[0] : "" }).append(g("<td />", { valign: "top", colSpan: ba(a), class: a.oClasses.sRowEmpty }).html(c))[0]);
            ...
            for (j = c.length; f < j; f++) {
                ...
                for (e = d.firstChild; e; ) {
                    if ("TD" == e.nodeName.toUpperCase() || "TH" == e.nodeName.toUpperCase()) {
                        ...
                        n = h;
                        q = 1 === l ? !0 : !1;
                        for (i = 0; i < l; i++) for (h = 0; h < r; h++) (a[f + h][n + i] = { cell: e, unique: q }), (a[f + h].nTr = d);
                    }
                    e = e.nextSibling;
                }
            }
        ...
        function ub(a) {
            ...
            for (h = 0; h < c; h++)
                (n = b[h]),
                    ...
                    k.columns.push({ data: j, name: n.sName, searchable: n.bSearchable, orderable: n.bSortable, search: { value: l.sSearch, regex: l.bRegex } }),
                    q("mDataProp_" + h, j),
        ...
        function ob(a) {
            for (
                var b = a.oClasses, c = a.sTableId, d = a.aLengthMenu, e = g.isArray(d[0]), f = e ? d[0] : d, d = e ? d[1] : d, e = g("<select/>", { name: c + "_length", "aria-controls": c, class: b.sLengthSelect }), h = 0, i = f.length;
                h < i;
                h++
            )
            ...
            j = g("<div/>", { class: f.sScrollWrapper })
                .append(
                    g("<div/>", { class: f.sScrollHead })
                        .css({ overflow: "hidden", position: "relative", border: 0, width: d ? (!d ? null : u(d)) : "100%" })
                        .append(
                ...
                .append(
                    g("<div/>", { class: f.sScrollBody })
                        .css({ position: "relative", overflow: "auto", width: !d ? null : u(d) })
                        .append(b)
                );
            l &&
                j.append(
                    g("<div/>", { class: f.sScrollFoot })
                        .css({ overflow: "hidden", border: 0, width: d ? (!d ? null : u(d)) : "100%" })
                        .append(
        ...
        function Ib() {
            ...
            if (a === k) {
                var b = g("<p/>").css({ position: "absolute", top: 0, left: 0, width: "100%", height: 150, padding: 0, overflow: "scroll", visibility: "hidden" }).appendTo("body"),
        ...
        function V(a) {
            ...
            for (a = 0; a < n.length; a++) {
                ...
                for (c = f.length; b < c; b++)
                    (h = f[b]), (i = e[h].sType || "string"), n[a]._idx === k && (n[a]._idx = g.inArray(n[a][1], e[h].asSorting)), d.push({ src: j, col: h, dir: n[a][1], index: n[a]._idx, type: i, formatter: m.ext.type.order[i + "-pre"] });
            }
            return d;
        }
        function mb(a) {
        ...
        function Kb(a) {
            for (var b, c, d = a.aoColumns, e = V(a), a = a.oLanguage.oAria, f = 0, h = d.length; f < h; f++) {
                ...
                c.bSortable &&
                    (0 < e.length && e[0].col == f ? (g.setAttribute("aria-sort", "asc" == e[0].dir ? "ascending" : "descending"), (c = i[e[0].index + 1] || i[0])) : (c = i[0]), (b += "asc" === c ? a.sSortAscending : a.sSortDescending));
        ...
        function Va(a, b, c, d) {
            ...
            c && a.oFeatures.bSortMulti
                ? ((c = g.inArray(b, D(e, "0"))),
                  -1 !== c ? ((b = h(e[c], !0)), null === b && 1 === e.length && (b = 0), null === b ? e.splice(c, 1) : ((e[c][1] = f[b]), (e[c]._idx = b))) : (e.push([b, f[0], 0]), (e[e.length - 1]._idx = 0)))
                : e.length && e[0][0] == b
        ...
        m = function (a) {
            ...
            this.each(function () {
                ...
                if ("table" != this.nodeName.toLowerCase()) J(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    j = o.oClasses;
                    f.bJQueryUI
                        ? (g.extend(j, m.ext.oJUIClasses, f.oClasses), f.sDom === l.sDom && "lfrtip" === l.sDom && (o.sDom = '<"H"lfr>t<"F"ip>'), o.renderer)
                            ? g.isPlainObject(o.renderer) && !o.renderer.header && (o.renderer.header = "jqueryui")
                            : (o.renderer = "jqueryui")
        ...
        p("search()", function (a, b, c, d) {
            ...
            return a === k
                ...
                : this.iterator("table", function (e) {
                      e.oFeatures.bFilter && ga(e, g.extend({}, e.oPreviousSearch, { sSearch: a + "", bRegex: null === b ? !1 : b, bSmart: null === c ? !0 : c, bCaseInsensitive: null === d ? !0 : d }), 1);
                  });
        });
        s("columns().search()", "column().search()", function (a, b, c, d) {
            return this.iterator("column", function (e, f) {
                ...
                e.oFeatures.bFilter && (g.extend(h[f], { sSearch: a + "", bRegex: null === b ? !1 : b, bSmart: null === c ? !0 : c, bCaseInsensitive: null === d ? !0 : d }), ga(e, e.oPreviousSearch, 1));
            });
        });
        p("state()", function () {
                        ...
                        m = function (b, d) {
                            ...
                            for (q = d.length; p < q; p++) {
                                ...
                                if (g.isArray(s)) {
                                    ...
                                    if (j !== null) {
                                        t = g("<a>", { class: h.sPageButton + " " + k, "aria-controls": a.sTableId, "data-dt-idx": l, tabindex: a.iTabIndex, id: c === 0 && typeof s === "string" ? a.sTableId + "_" + s : null })
                                            .html(j)
                                            .appendTo(b);
                                        Wa(t, { action: s }, u);
                                        l++;
                        ...
                        if (((a = d[k]), b.isArray(a))) p(c, a);
                            ...
                            e &&
                                ((o = b("<li>", { class: u.sPageButton + " " + f, id: 0 === r && "string" === typeof a ? g.sTableId + "_" + a : null })
                                    .append(b("<a>", { href: "#", "aria-controls": g.sTableId, "data-dt-idx": n, tabindex: g.iTabIndex }).html(e))
                                    .appendTo(c)),
