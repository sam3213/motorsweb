                ...
                <section id="main-content">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="stat-widget-one">
                                    <div class="stat-icon dib"><i class="ti-user color-dark border-danger"></i>
                                    </div>
                                    <?php
                                        usuariosregistrados()
                                    ?>
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="stat-widget-one">
                                    <div class="stat-icon dib"><i class="ti-layout-grid2 color-dark border-danger"></i>
                                    </div>
                                    <?php
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="stat-widget-one">
                                    <div class="stat-icon dib"><i class="ti-truck color-dark border-danger"></i></div>
                                    <?php
