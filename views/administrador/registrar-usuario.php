                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="text-left clearfix" action="../../controllers/registrarUserAdmin.php" method="POST" enctype="multipart/form-Data">
            <div class="row ">
              ...
              <div class="form-group col-md-12">
                ...
                <input type="file" class="form-control"  placeholder="Foto usuario" name="foto" accept=".jpeg, .jpg, .png, .gif">
              </div>
            </div>
            <div class="text-center">
              <button type="submit"  class="btn btn-main text-center" >Registrar</button>
            </div>
          </form>
                                    </div>
                                </div>
