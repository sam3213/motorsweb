                                ...
                                <div class="card-body">
                                    <div class="basic-elements">
                                        <form class="text-left clearfix"
                                            action="../../controllers/registrarServiciosAdmin.php" method="POST"
                                            enctype="multipart/form-Data">
                                            <div class="row ">
                                                <div class="form-group col-md-6">
                                                    <input type="text" class="form-control"
                                                        placeholder="Porveedor" name="proveedor">
                                                </div>
                                                <div class="form-group col-md-6">
                                                ...
                                                <textarea name="descripcion" id="" cols="139"  placeholder="Descripcion del servicio" rows="3" style="resize:none;"></textarea>
                                                </div>
