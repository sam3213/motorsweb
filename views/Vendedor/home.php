                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Hola, <span>Vendedor, bienvenido</span></h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                ...
                <section id="main-content">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="stat-widget-one">
                                    <div class="stat-icon dib"><i class="ti-money color-white border-danger"></i>
                                    </div>
                                    <div class="stat-content dib">
                                        <div class="stat-text">Mis ventas</div>
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="stat-widget-one">
                                    <div class="stat-icon dib"><i class="ti-layout-grid2 color-white border-danger"></i>
                                    </div>
                                    <?php
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="stat-widget-one">
                                    <div class="stat-icon dib"><i class="ti-truck color-white border-danger"></i></div>
                                    <?php
